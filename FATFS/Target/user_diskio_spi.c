...
#define CS_HIGH()	{HAL_GPIO_WritePin(CS_CARD_PIN_GPIO_Port, CS_CARD_PIN_Pin, GPIO_PIN_SET);}
#define CS_LOW()	{HAL_GPIO_WritePin(CS_CARD_PIN_GPIO_Port, CS_CARD_PIN_Pin, GPIO_PIN_RESET);}
